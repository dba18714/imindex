...
# env.read_env('.env')
#
# print("Testing .env loading:", env("SECRET_KEY", default="Env not loaded"))
#
...
# ]
#
# CELERY_BROKER_URL = 'redis://fdaa:3:d8f9:a7b:1d6:b5ac:fb00:2:6379/0'  # 测试：redis-cli -h fdaa:3:d8f9:a7b:1d6:b5ac:fb00:2 -p 6379
#
